...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    queryInterface.sequelize.query(
      `CREATE TABLE IF NOT EXISTS "Token" ("token_id"  SERIAL , "token_type" VARCHAR(255), "stripe_token_id" VARCHAR(255), "stripe_customer_id" VARCHAR(255), "stripe_card_id" VARCHAR(255), "stripe_card_country" VARCHAR(255), "stripe_card_brand" VARCHAR(255), "stripe_card_cvc_check" VARCHAR(255), "stripe_card_exp_month" INTEGER, "stripe_card_exp_year" INTEGER, "stripe_card_last4" VARCHAR(255), "slimpay_rum_id" VARCHAR(255), "slimpay_token_id" VARCHAR(255), "slimpay_rum_code" VARCHAR(255), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "client_id" INTEGER REFERENCES "Client" ("client_id") ON DELETE SET NULL ON UPDATE CASCADE, PRIMARY KEY ("token_id"));`
    )
    queryInterface.sequelize.query(
